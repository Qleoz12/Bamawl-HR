...
import ConfirmAndRejectBusinessTripList from './ConfirmAndRejectBusinessTripList';

const BusinessTripListTable = props => {
    ...
    return (<>
        {
            ...
            <CCard className='table-panel mt-2' style={{ backgroundColor: "#fafbfc", border: "1px solid #c8ccd0" }}>
                                            ...
                                            return (<Fragment key={index}>
                                                <tr width="100%">
                                                    <td className="td-num basicSalaryList tbodyCheckbox" >
                                                        {!props.isAdjustment ? i.business_trip && i.business_trip.show_confirm &&
                                                            <input type="checkbox"
                                                                value={i.business_trip_id}
                                                                id={i.id}
                                                                checked={i.is_checked === true}
                                                                onChange={props.changeCheckbox}
                                                            /> : props.isAdjustment && i.business_trip_adjustment && i.business_trip_adjustment.show_confirm &&
                                                        <input type="checkbox"
                                                            value={i.business_trip_id}
                                                            id={i.id}
                                                            checked={i.is_checked === true}
                                                    ...
                                                    <td width="" className="textAlignLeft td-orange" >
                                                        {i.expense_department_name}
                                                    </td>
                                                    <td width="" className="textAlignCenter" >
                                                        {i.business_trip_period && i.business_trip_period.trip_period_from_date ?
                                                            i.business_trip_period.trip_period_from_date.substring(0, 10) : ""}<br />
                                                        {i.business_trip_period && i.business_trip_period.trip_period_to_date ?
                                                            i.business_trip_period.trip_period_to_date.substring(0, 10) : ""}
                                                    </td>
                                                    {props.currencies && props.currencies.map((item, ix) => {
                                                        return (
                                                            <td key={ix} width="" className="textAlignRight td-green" >
                                                                {i.business_trip && i.business_trip.estimate_budget && i.business_trip.estimate_budget.map((val, k) => {
                                                    ...
                                                    {props.currencies && props.currencies.map((item, ix) => {
                                                        return (
                                                            <td key={ix} width="" className="textAlignRight td-green" >
                                                                {i.business_trip && i.business_trip.advance_money && i.business_trip.advance_money.map((val, k) => {
                                                                    if (val.currency_id === item.id) {
                                                                        return (<Fragment key={k}>
                                                                            {val.value}
                                                                        </Fragment>)
                                                    ...
                                                    <td width="" className="textAlignCenter td-green" >
                                                        {i.business_trip &&
                                                            i.business_trip.applied_date ?
                                                            i.business_trip.applied_date.substring(0, 10) : ""}
                                                    </td>
                                                    <td width="" className="textAlignCenter td-green" style={{ whiteSpace: "nowrap" }}>
                                                        {i.business_trip &&
                                                            i.business_trip.due_date ?
                                                            i.business_trip.due_date.substring(0, 10) : ""}
                                                    </td>
                                                    <td width="" className="td-green" style={{ padding: i.business_trip && i.business_trip.show_edit ? "" : "25px" }}>
                                                        {i.business_trip && i.business_trip.show_edit ?
                                                            <input
                                                                type="image"
                                                                id="tblEdit"
                                                                ...
                                                                alt="edit"
                                                                onClick={props.editToggleAlertBusinessTrip.bind(this, i)}
                                                            /> : ""
                                                        }
                                                    </td>
                                                    <td width="" className="td-green" style={{ padding: i.business_trip && i.business_trip.show_delete ? "" : "25px" }}>
                                                        {i.business_trip && i.business_trip.show_delete ?
                                                            <input
                                                                type="image"
                                                                id="tblDelete"
                                                                ...
                                                                className="icon-clt epm-list-img"
                                                                alt="delete"
                                                                onClick={props.deleteToggleAlertBusinessTrip.bind(this, i)}
                                                            /> : ""
                                                        }
                                                    </td>
                                                    <td width="" className="td-green" style={{ padding: i.business_trip && i.business_trip.detail ? "" : "25px" }}>
                                                        {i.business_trip && i.business_trip.detail ?
                                                            <input
                                                                type="image"
                                                                id="tblDetail"
                                                                ...
                                                                className="icon-clt epm-list-img"
                                                                alt="detail"
                                                                onClick={props.getDetailsBusinessTrip.bind(this, i)}
                                                            /> : ""
                                                        }
                                                    </td>
                                                    <td width="" className="textAlignLeft td-green" style={{ whiteSpace: "nowrap" }}>
                                                        {(() => {
                                                            switch (i.business_trip && i.business_trip.approve_flag) {
                                                    ...
                                                    {props.currencies && props.currencies.map((item, ix) => {
                                                        return (
                                                            <td key={ix} width="" className="textAlignRight td-blue" >
                                                                {i.business_trip_adjustment ? i.business_trip_adjustment.actual_total &&
                                                                    i.business_trip_adjustment.actual_total.map((val, k) => {
                                                                        if (val.currency_id === item.id) {
                                                                            return (<Fragment key={k}>
                                                                                {val.value ? val.value : ""}
                                                                            </Fragment>)
                                                    ...
                                                    {props.currencies && props.currencies.map((item, ix) => {
                                                        return (
                                                            <td key={ix} width="" className="textAlignRight td-blue" >
                                                                {i.business_trip_adjustment ? i.business_trip_adjustment.adjustment_amt &&
                                                                    i.business_trip_adjustment.adjustment_amt.map((val, k) => {
                                                                        if (val.currency_id === item.id) {
                                                                            return (<Fragment key={k}>
                                                                                {val.value ? val.value : ""}
                                                                            </Fragment>)
                                                    ...
                                                    <td width="" className="textAlignCenter td-blue" >
                                                        {i.business_trip_adjustment &&
                                                            i.business_trip_adjustment.applied_date ?
                                                            i.business_trip_adjustment.applied_date.substring(0, 10) : ""}
                                                    </td>
                                                    <td width="" className="textAlignCenter td-blue" style={{ whiteSpace: "nowrap" }}>
                                                        {i.business_trip_adjustment &&
                                                            i.business_trip_adjustment.due_date ?
                                                            i.business_trip_adjustment.due_date.substring(0, 10) : ""}
                                                    </td>
                                                    <td width="" className="td-blue" style={{ padding: i.business_trip_adjustment && i.business_trip_adjustment.show_edit ? "" : "25px" }}>
                                                        {i.business_trip_adjustment && i.business_trip_adjustment.show_edit ?
                                                            <input
                                                                type="image"
                                                                id="tblEdit"
                                                                src={'avatars/edit.png'}
                                                                className="icon-clt epm-list-img"
                                                                alt="edit"
                                                                onClick={props.editToggleAlertBusinessTripAdjustment.bind(this, i)}
                                                            /> : ""
                                                        }
                                                    </td>
                                                    <td width="" className="td-blue" style={{ padding: i.business_trip_adjustment && i.business_trip_adjustment.show_delete ? "" : "25px" }}>
                                                        {i.business_trip_adjustment && i.business_trip_adjustment.show_delete ?
                                                            <input
                                                                type="image"
                                                                id="tblDelete"
                                                                src={'avatars/remove.png'}
                                                                className="icon-clt epm-list-img"
                                                                alt="delete"
                                                                onClick={props.deleteToggleAlertBusinessTripAdjustment.bind(this, i)}
                                                            /> : ""
                                                        }
                                                    </td>
                                                    <td width="" className="td-blue" style={{ padding: i.business_trip_adjustment && i.business_trip_adjustment.detail ? "" : "25px" }}>
                                                        {i.business_trip_adjustment && i.business_trip_adjustment.detail ?
                                                            <input
                                                                type="image"
                                                                id="tblDetail"
                                                                src={'avatars/detail-user.png'}
                                                                className="icon-clt epm-list-img"
                                                                alt="detail"
                                                                onClick={props.getDetailsBusinessTripAdjusment.bind(this, i)}
                                                            /> : ""
                                                        }
                                                    </td>
                                                    <td width="" className="textAlignLeft td-blue" style={{ whiteSpace: "nowrap" }}>
                                                        {
                                                            i.reject_history ? t("Re-Pending") : (() => {
                                                                switch (i.business_trip_adjustment && i.business_trip_adjustment.approve_flag) {
                                                    ...
                                                    <td width="" className="textAlignLeft" >
                                                        {i.bz_trip_adj_request && !i.bz_trip_adj_request_again && !i.reject_history ?
                                                            <a style={{ color: "#4E57AA", borderBottom: "1px solid", cursor: "pointer" }}
                                                                onClick={i.reject_history ?
                                                                    props.openRejectHistoryModal.bind(this, i) : props.linkAdjustmentRequest.bind(this, i)}>
                ...
                <ConfirmAndRejectBusinessTripList
