...
import AccommodationTableBusinessTripAdjustment from './AccommodationTableBusinessTripAdjustment';
import DatePicker from '../../hr-common/datepicker/DatePicker';

const AccommodationBusinessTripAdjustment = props => {
    let {
        allCurrency,
        data, setData,
        subTotal,
        ...
        <>
            <CRow lg="12">
                <CCol className="">
                    ...
                    <CLabel style={{ fontWeight: "bold" }} id="lbAccommodation" className="title-lbl">{t('Accommodation')}</CLabel>
                </CCol>
            </CRow>
            <CRow lg="12">
                <CCol className="">
                    <CCard className="table-panel table-panel-businesstrip-adjustment">
                            ...
                            <CCol className="" lg="5" style={{ marginBottom: "20px" }}>
                                ...
                                <CRow>
                                    ...
                                    <CCol md="5">
                                        ...
                                        <CSelect className="bamawl-select" value={unitCurrency} name="unit" onChange={(e) => handleChangeCurrency(e, acceptCurrency, unitCurrency, setFlagHidden, setAcceptAmountState, setUnitCurrency, setAcceptCurrency, totalState, fxRateState)} custom>
                                            {
                        ...
                        <CRow lg="12">
                            <CCol lg="5" className="mb-4">
                                <CLabel id="lblCheckIn" className="required">{t('Check In')}</CLabel>
                            ...
                            <CCol lg="5" className="mb-4">
                                <CLabel id="lblCheckOut" className="required">{t('Check Out')}</CLabel>
                                <DatePicker value={checkOutState} change={(e) => handleChangeOutDate(e, setCheckOutState)} />
                            </CCol>
                        </CRow>
                        <CRow lg="12" className="move_from_bottom">
                            ...
                            <CCol className="" xl="5" lg="5" style={{ marginBottom: "20px" }}>
                                ...
                                <div className="pt-lg-4">
                                    ...
                                    &nbsp;
                                    <a id="importFileAccomm" className="expense-request-attachment-file-browser" tabIndex={0}>
                                        {t('Browse')}
                                    </a>
                                    <input
                                        value=""
                                        type="file"
                                        htmlFor="importFileAccomm"
                        ...
                        <CCol lg="12" style={{ textAlign: "center" }}>
                            <CButton id="btnAdd" className="btn form-btn" onClick={() => btnAddRow(titleState, unitPriceState, timesState, acceptCurrency, unitCurrency, fxRateState, checkInState, checkOutState, multiFile, checkerState, descriptionState, setData, data, "Accommodation")}>{t('ADD')}</CButton>
                        </CCol>
                        <br />
                        <AccommodationTableBusinessTripAdjustment
...
export default AccommodationBusinessTripAdjustment;