...
const OtherTableBusinessTripAdjustment = props => {
              ...
              <CCol lg="12">
                <div className="table-responsive">
                  <table className="table purchase-order-list" aria-label="simple table">
                    <thead id="thead-id">
                      <tr width="100%">
                        <th id="lblNo" className="text-nowrap text-left align-middle" rowSpan={2} >
                          <CImg
                        ...
                        <th id="lblDate" className="text-left " rowSpan={2} >
                          <CImg
                            src={"avatars/titleicon.png"}
                            className="imgTitle"
                            alt="no"
                        ...
                        <th id="lblTitle" className="text-nowrap text-left align-middle" rowSpan={2} >
                          <CImg
                            src={"avatars/titleicon.png"}
                            className="imgTitle"
                            alt="no"
                        ...
                        <th id="lblAttachement" className="text-nowrap text-left align-middle" rowSpan={2} >
                          <CImg
                            src={"avatars/titleicon.png"}
                            className="imgTitle"
                            alt="no"
                        ...
                        <th id="lblDescription" className="text-nowrap text-left align-middle" rowSpan={2} >
                          <CImg
                            src={"avatars/titleicon.png"}
                            className="imgTitle"
                            alt="no"
                        ...
                        <th id="lblBudgetCost" className="text-nowrap align-middle" colSpan={6} style={{ borderBottom: "1px solid #fff" }} >
                          <CImg
                            src={"avatars/titleicon.png"}
                            className="imgTitle"
                            alt="no"
                        ...
                        <th id="lblActualCost" className="text-nowrap align-middle" colSpan={7} style={{ borderBottom: "1px solid #fff" }} >
                          <CImg
                            src={"avatars/titleicon.png"}
                            className="imgTitle"
                            alt="no"
                        ...
                        <th id="lblAction" className="text-nowrap text-left align-middle" rowSpan={2} >
                          <CImg
                            src={"avatars/titleicon.png"}
                            className="imgTitle"
                            alt="no"
                    ...
                    <tbody >
                          ...
                          return (
                            <tr key={index}>
                                      ...
                                      return (
                                        <tr key={idx}>
                                          <td className="text-left" style={{ border: "none", backgroundColor: '#d5f7df' }}>
                                            ...
                                            <i className="fa fa-times" style={{ cursor: "pointer" }} onClick={() => btnRemoveFileInTable(index, idx, data, setData, "Other")} ></i>
                                          </td>
                                        </tr>
                                      )
                                    })}
                              ...
                              <td className="td-cost textcenter td-actual">
                                {
                                  ele.flag === 0 ? ele.actual_cost.unit_price :
                                    <CInput style={{ textAlign: "right" }} value={ele.actual_cost.unit_price} hidden={ele.flag === 1} name="Unit Price" onChange={(e) => onchangeInput(ele, e, data, setData, "Other")} />
                                }
                              </td>
                              <td className="td-cost textcenter td-actual">
                                {
                                  ele.flag === 0 ? ele.actual_cost.day_times :
                                    <CInput style={{ textAlign: "right" }} value={Number(ele.actual_cost.day_times)} hidden={ele.flag === 1} name="Qty" onChange={(e) => onchangeInput(ele, e, data, setData, "Other")} />
                                }
                              </td>
                              ...
                              <td className="td-cost textcenter td-actual">
                                {
                                  ele.flag === 0 ? ele.actual_cost.fx_rate :
                                    <CInput disabled={ele.actual_cost.unit_price_currency_id == ele.actual_cost.accept_currency_id ? true : false} style={{ textAlign: "right" }} value={ele.actual_cost.fx_rate} hidden={ele.flag === 1} name="FX Rate" onChange={(e) => onchangeInput(ele, e, data, setData, "Other")} />
                                }
                              </td>
                              <td className="td-drop textcenter td-actual">
                                {
                                  ele.flag === 0 ? allCurrency.map(item => item.id == ele.actual_cost.accept_currency_id ? item.currency_desc : "") :
                                    <CSelect value={ele.actual_cost.accept_currency_id} hidden={ele.flag === 1} name={ele.id} onChange={(e) => onchangeAcceptDropdown(e, data, setData, "Other")} >
                                      {allCurrency.map((ele, index) => {
                                        return (
                                          ele.expense_flag === 1 &&
                                          <option key={index} value={ele.id}>{ele.currency_desc}</option>
                              ...
                              <td className="td-action textcenter">
                                <CImg src={'avatars/remove.png'} className="icon-clt" alt="titleicon" onClick={() => btnRemoveRowTable(data, setData, ele, index, "Other")} />
                              </td>
                            </tr>
                          )
                        })
                      ...
                      <tr>
                        ...
                        <td colSpan="3" className="textright col-color-green">
                          {data.budget_cost && data.budget_cost[0] ? data.budget_cost[0].sub_total.toFixed(2) : parseFloat(0).toFixed(2)}
                        </td>
                          ...
                          return (index != 0 && ele.expense_flag === 1 &&
                            <tr style={{ background: "#d8dbe0" }} key={index}>
                              ...
                              <td colSpan="3" className="textright col-color-green no-border-radius">
                                {data.budget_cost && data.budget_cost[index] ? data.budget_cost[index].sub_total.toFixed(2) : parseFloat(0).toFixed(2)}
                              </td>
                              <td colSpan="3" className="col-color-green">
                                {ele.currency_desc}
                              </td>
...
export default OtherTableBusinessTripAdjustment
