...
import TransportationTableBusinessTripAdjustment from './TransportationTableBusinessTripAdjustment';
import DatePicker from '../../hr-common/datepicker/DatePicker'; 

const TransportationBusinessTripAdjustment = props => {
    let {
        allCurrency,
        data, setData,
        subTotal,
        ...
        <>
            <CRow lg="12">
                <CCol className="">
                    ...
                    <CLabel style={{ fontWeight: "bold" }} id="lblTransportation" className="title-lbl">{t('Transportation')}</CLabel>
                </CCol>
            </CRow>
            <CRow lg="12">
                <CCol className="">
                    <CCard className="table-panel table-panel-businesstrip-adjustment">
                        ...
                        <CRow lg="12" className="move_from_bottom">
                            ...
                            <CCol className="" xl="5" lg="5" style={{ marginBottom: "20px" }}>
                                ...
                                <div className="pt-lg-4">
                                    ...
                                    &nbsp;
                                    <a id="importFileTransport" className="expense-request-attachment-file-browser" tabIndex={0}>
                                        {t('Browse')}
                                    </a>
                                    <input
                                        value=""
                                        type="file"
                                        htmlFor="importFileTransport"
                        ...
                        <CCol lg="12" style={{ textAlign: "center" }}>
                            <CButton id="btnAdd" className="btn form-btn" onClick={() => btnAddRow(titleState, unitPriceState, timesState, acceptCurrency, unitCurrency, fxRateState, checkInState, null, multiFile, checkerState, descriptionState, setData, data, "Transportation")}>{t('ADD')}</CButton>
                        </CCol>
                        <br />
                        <TransportationTableBusinessTripAdjustment
...
export default TransportationBusinessTripAdjustment;