...
const SearchSSBCalculateSetupList = props => {
    ...
    return (<>
        ...
        <CRow lg="12">
            <CCol style={{ textAlign: "center" }}>
                <CButton hidden={editData != ""} id="btnSearch" className="form-btn" onClick={() => searchAPI()}>{t('Search')}</CButton>
            </CCol>
        </CRow><br />
    </>
    );
}
export default SearchSSBCalculateSetupList;