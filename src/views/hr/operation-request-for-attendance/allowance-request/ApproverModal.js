                ...
                <CRow id="approver-modal">
                        ...
                        <CRow lg="12" style={{marginBottom:'10px'}}>
                            <CCol lg="4" style={{borderRight:"1px solid #E3E5F1"}}>
                                    ...
                                    <CInput type="text" className="bamawl-input" value={props.appID} onChange={props.appIDChange} disabled />
                            </CCol>
                            <CCol lg="4" style={{borderRight:"1px solid #E3E5F1"}}>
                                    <CLabel htmlFor="app_code">{t('Employee Code')}</CLabel>
                                    <CInput type="text" className="bamawl-input" value={props.appCode} onChange={props.appCodeChange} disabled />
                            </CCol>
                            <CCol lg="4">
                                    <CLabel htmlFor="app_name">{t('Employee Name')}</CLabel>
                                    <CInput type="text" className="bamawl-input" value={props.appName} onChange={props.appNameChange} disabled />
                            </CCol>
                        </CRow>
