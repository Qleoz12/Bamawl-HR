...
import { CCard, CCardBody, CCardHeader, CCol, CRow, CButton, CFormGroup, CLabel, CSelect, CInput} from '@coreui/react';
...
const EmployeeLeaveListSearch=props=> {
  ...
  return (<>
          <CCard>
          <CCardHeader><h5><CLabel className="m-0">{t('Employee Leave Request List')}</CLabel></h5></CCardHeader>
          <CCardBody>
          ...
          <CRow className="mt-4">
                ...
                <CSelect className="bamawl-select" onChange={props.leaveTypeChange} value={props.leaveTypeState} custom>
                  ...
                  {props.leaveTypeAPI != "" &&
                    props.leaveTypeAPI.map((leaveType,index)=>{
                      return(
                        <option key={index} value={leaveType.id}>{leaveType.leave_name}</option>
                      )
                    })
                  }
                </CSelect>
            ...
            <CCol lg='1'></CCol>
            <CCol lg='5'>
              <CLabel className=' '>{t('Approver Status')}</CLabel>
              <CFormGroup className=' '>
          ...
          <CRow style={{display:'flex'}}>
            <CCol xs="12" md="12" className="mb-12">
              ...
              confirmRejectShow={props.confirmRejectShow}
              />
            </CCol>
          </CRow>
        </CCardBody>
