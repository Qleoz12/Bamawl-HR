                        ...
                        <CCol lg="12">
                            <CCol lg="12">
                                <CRow alignHorizontal="start">  
                                    ...
                                    <CImg className="m-left-19" src={'/avatars/icon_awesome_star1.png'} width="17px" height="17px" /><p className="m-left-10" style={{fontWeight: "bold",fontSize: "13px"}}>{t('Yearly Bonus Notification For This Month')}</p>
                                </CRow>
                            </CCol>
                            
                            {
                                ...
                                <div style={{marginLeft: "38px"}}>
                                    <div className="table-responsive tableFixHead" >
                                        <table className=" table bonus-notification" id="bonus_notification">
                                            <thead className="">
                                                <tr>
                                            ...
                                            <tbody className="">
                                                {
                                                    ...
                                                    return(
                                                            <tr width="100%" key={index}  className="">
                                                                ...
                                                                <td className="td-num" width="250px" style={{backgroundColor: "#d6f8b3"}}>
                                                                    {i.experience_year}
                                                                </td> 
                                                            </tr>
                                                    )
