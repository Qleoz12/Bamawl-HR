 ...
 */
const CheckProbationPeriod=props=> {
                        ...
                        <CCol lg="12">
                            <CCol lg="12">
                                <CRow alignHorizontal="start">
                                    ...
                                    {props.upDown == false &&
                                        <CImg src={'/avatars/group_8221.png'} width="17px" height="17px"  onClick={props.upDownBtn} className="pointer image-radius"/>
                                    }
                                    <CImg className="m-left-19" src={'/avatars/icon_awesome_star.png'} width="17px" height="17px" /><p className="m-left-10" style={{fontWeight: "bold",fontSize: "13px"}}>{t('Check Probation Period')}</p>
                                </CRow>
                            </CCol>
                            
                            {
                                ...
                                <div style={{marginLeft: "38px"}}>
                                    <div className="table-responsive tableFixHead" >
                                        <table className=" table probation-period" id="probation_period">
                                            <thead className="">
                                                <tr>
...
export default CheckProbationPeriod;
