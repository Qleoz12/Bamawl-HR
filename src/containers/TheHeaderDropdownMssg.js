      ...
      <CDropdownMenu className="pt-0" placement="bottom-end">
        ...
        <CDropdownItem href="#">
          <div className="message">
            ...
            <div>
              ...
              <small className="text-muted float-right mt-1">5 </small>
            </div>
            <div className="text-truncate font-weight-bold">Lorem </div>
            <div className="small text-muted text-truncate">Lorem 
            </div>
          </div>
        </CDropdownItem>
        ...
        <CDropdownItem href="#">
          <div className="message">
            ...
            <div className="text-truncate font-weight-bold">Loremt</div>
            <div className="small text-muted text-truncate">Lorem 
            </div>
          </div>
        </CDropdownItem>
        <CDropdownItem href="#" className="text-center border-top"><strong>View</strong></CDropdownItem>
      </CDropdownMenu>
    </CDropdown>
  )
}
